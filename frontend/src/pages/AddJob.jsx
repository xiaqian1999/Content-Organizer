    ...
    <div className='text-gray-600 absolute z-1 w-full h-screen py-3 grid' style={{backgroundColor: '#00000090'}}>
      <form className='flex flex-col place-self-center bg-white p-5 rounded w-[550px]' onSubmit={onSubmitHandler}>
        ...
        <div className='flex flex-col mb-4'>
          ...
          <input onChange={onChangeHandler} value={data.application_url} type="url" name="application_url" className='p-2 border border-gray-400 rounded' required />
        </div>
        ...
        <div className='flex flex-wrap justify-between my-2'>
          <div className='flex flex-col mb-4' style={{width: "48%"}}>
            ...
            <input onChange={onChangeHandler} value={data.salary_range} type="number" name="salary_range" className='p-2 border border-gray-400 rounded' />
          </div>

          <div className='flex flex-col mb-4' style={{width: "48%"}}>
            <p className=''>Year of Experience</p>
            <input onChange={onChangeHandler} value={data.year_of_experience} type="text" name="year_of_experience" className='p-2 border border-gray-400 rounded' />
          </div>
        </div>
        ...
        <div className='flex flex-wrap justify-between my-2'>
          <div className='flex flex-col mb-4' style={{width: "48%"}}>
            ...
            <input onChange={onChangeHandler} value={data.locations} type="text" name="locations" className='p-2 border border-gray-400 rounded' />
          </div>

          <div className='flex flex-col mb-4' style={{width: "48%"}}>
            <p className=''>Rate of Interest</p>
            <input onChange={onChangeHandler} value={data.rate_interest} type="text" name="rate_interest" className='p-2 border border-gray-400 rounded' />
          </div>
        </div>

        <div className='flex flex-col mb-4'>
          <p className=''>Additional Note</p>
          <textarea onChange={onChangeHandler} value={data.additional_note} type="text" name="additional_note" className='p-2 border border-gray-400 rounded'>
          </textarea>
        </div>

        <div className='flex flex-wrap mb-2 place-content-end'>
          <button onClick={() => setShowAddJob(false)} className='text-white bg-gray-600 hover:bg-gray-700 cursor-pointer px-3 py-2 rounded mx-1'>Close</button>
